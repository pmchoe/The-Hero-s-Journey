class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // add Hero
        this.player = new Hero(this, 100, 450, 'textureAtlas', 'textureAtlasSplit-0.png').setOrigin(1, 0.5);
        
        // DELETE LATER, spawns ONE enemy
        this.enemy = new BadGuy(this, 100, 450, 'textureAtlas', 'textureAtlasSplit-9.png').setOrigin(0, 0.5);
